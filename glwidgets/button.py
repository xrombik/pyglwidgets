...
class Button(glwidget.GlWidget):
	...
	def redraw(self):
		...
		if self.text and (self.texture2 is None):
			...
			xbearing, ybearing, text_width, text_height, xadvance, yadvance = glwidget.GlWidget.cairo_context.text_extents(self.text)
...
class ButtonRing(Button):
	...
	"""
	def __init__(self, gda, pos, textures, r1, r2, state_colors=(gltools.colors.ALPHA0, gltools.colors.RED1), user_proc=None, user_data=None):
		"""
