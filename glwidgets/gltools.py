#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Составная часть ПО прибора П16, для проекта "22800"
...
def draw_texture(texture, pos, col=(255, 255, 255, 255), mirror = MIRROR_NONE):
	...
	glBegin(GL_QUADS)
	glTexCoord2f(mirror[0], mirror[1]);	glVertex2f(0, 0)
	glTexCoord2f(mirror[2], mirror[3]);	glVertex2f(texture[1], 0)
	glTexCoord2f(mirror[4], mirror[5]);	glVertex2f(texture[1], texture[2])
	glTexCoord2f(mirror[6], mirror[7]);	glVertex2f(0, texture[2])
	glEnd()
